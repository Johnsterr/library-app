...
Подключен PassportJS с использованием локальной стратегии аутентификации.

Переписаны API-маршруты:

| Метод  | URL                | Действие                                | Комментарий                                        |
| ------ | ------------------ | --------------------------------------- | -------------------------------------------------- |
| `GET`  | `/api/user/`       | Просмотр главной страницы пользователей |                                                    |
| `GET`  | `/api/user/login`  | Просмотр страницы входа                 |                                                    |
| `GET`  | `/api/user/signup` | Просмотр страницы регистрации           |                                                    |
| `GET`  | `/api/user/me`     | Просмотр страницы профиля               | Если нет авторизации, редиректит на страницу входа |
| `GET`  | `/api/user/logout` | Сброс авторизации                       | Редирект на главную страницу                       |
| `POST` | `/api/user/login`  | Отправка запроса на вход                | После входа редиректит на главную страницу         |
| `POST` | `/api/user/signup` | Отправка запроса на регистрацию         | После регистрации редиректит на страницу входа     |
